...
public class ListAdapter_lineup extends BaseAdapter {

    LineUp main;

    public ListAdapter_lineup(LineUp main) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.p_position_str = this.main.live_data_list.get(position).p_position;
        holder.a_position_str = this.main.live_data_list.get(position).a_position;
        ...
        if (holder.p_name != null && !holder.p_name.equals(null) && !holder.p_name.isEmpty() || (holder.p_type != null && !holder.p_type.equals(null) && !holder.p_type.isEmpty())) {
            ...
            if (holder.p_type.equals("selection")) {
        ...
        if (holder.a_name != null && !holder.a_name.equals(null) && !holder.a_name.isEmpty() || (holder.a_type != null && !holder.a_type.equals(null) && !holder.a_type.isEmpty())) {
            ...
            if (holder.a_type.equals("selection")) {
              /*  if (!holder.a_logo.equals(null)&&!holder.a_logo.isEmpty()) {
                Picasso.with(main.getContext()).load(holder.a_logo).placeholder(R.drawable.football_player_small).into(holder.img1);
            }else{

                Picasso.with(main.getContext()).load(R.drawable.football_player_small).placeholder(R.drawable.football_player_small).into(holder.img1);
            }*/
