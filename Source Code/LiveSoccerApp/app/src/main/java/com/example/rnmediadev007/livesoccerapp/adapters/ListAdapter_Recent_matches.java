...
import com.example.rnmediadev007.livesoccerapp.activity.Live_matches_Details;
...
public class ListAdapter_Recent_matches extends BaseAdapter {
    ...
    public ListAdapter_Recent_matches(Recent_matches_Fragment main) {
    ...
    @Override
    public int getCount() {
        return main.recent_data_list.size();
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.home_team_score = this.main.recent_data_list.get(position).data_home_score;
        holder.away_team_score = this.main.recent_data_list.get(position).data_away_score;
        holder.minutes_str = this.main.recent_data_list.get(position).data_minute;
        ...
        holder.home_team_name.setText(this.main.recent_data_list.get(position).data_home_team_name);
        holder.away_team_name.setText(this.main.recent_data_list.get(position).data_away_team_name);
        holder.counteryName.setText(this.main.recent_data_list.get(position).data_country_name);
        holder.counteryFlag = this.main.recent_data_list.get(position).data_country_flag;
        holder.home_logo = this.main.recent_data_list.get(position).data_home_team_logo;
        holder.away_logo = this.main.recent_data_list.get(position).data_away_team_logo;
        holder.date_str = this.main.recent_data_list.get(position).data_starting_date;
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                opn.putExtra("id", main.recent_data_list.get(position).data_id);
                opn.putExtra("home_team_id", main.recent_data_list.get(position).data_home_team_id);
                opn.putExtra("away_team_id", main.recent_data_list.get(position).data_away_team_id);
                opn.putExtra("name", main.recent_data_list.get(position).data_venue_name);
                opn.putExtra("countery", main.recent_data_list.get(position).data_country_name);
